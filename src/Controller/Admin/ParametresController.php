...
class ParametresController extends AbstractController
{
    ...
    public function listParam(Request $request, 
        ...
        $listParams = $parametresRepository->findByType($type);
        $parents = $parametresRepository->findBy(['type' => $type, 'parent' => null]);
    ...
    public function newParam(
        ...
        $param = $id ? $parametresRepository->find($id) : new Parametres();
        ...
        if ($request->isMethod('POST')) {
            ...
            $parent = ($parentId && is_numeric($parentId)) ? $parametresRepository->find($parentId) : null;

            $pageId = $request->request->get("page");
            $page = ($pageId && is_numeric($pageId)) ? $pageRepository->find($pageId) : null;
